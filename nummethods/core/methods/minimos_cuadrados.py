    ...
    try:
        ...
        if len(x) < 2:
            return {
                "status": "error",
                "method": "minimos_cuadrados",
                "message": "Se requieren al menos dos puntos para aplicar mínimos cuadrados.",
                "iterations": []
            }
        ...
        if abs(denominator) < 1e-12:
            return {
                "status": "error",
                "method": "minimos_cuadrados",
                "message": "No es posible calcular la recta de ajuste porque el denominador es cero.",
                "iterations": []
            }
        ...
        return {
            ...
            "message": "Ajuste por mínimos cuadrados realizado correctamente."
        }
        ...
        return {
            "status": "error",
            "method": "minimos_cuadrados",
            "message": f"Ocurrió un error al aplicar mínimos cuadrados: {str(e)}",
            "iterations": []
        }